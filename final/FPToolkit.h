...
*  I am using an IDE (JetBrains CLION) which allows me to step thru code visually
...
//    Atom WM_DELETE_WINDOW = XInternAtom(XxDisplay, "WM_DELETE_WINDOW", False);
//    XSetWMProtocols(XxDisplay, XxWindow, &WM_DELETE_WINDOW, 1);
//
//    while (1) {
//        XNextEvent(XxDisplay, &e);
//        if (e.type == Expose) {
//            XFillRectangle(XxDisplay, XxWindow, DefaultGC(d, s), 20, 20, 10, 10);
//            XDrawString(XxDisplay, XxWindow, DefaultGC(XxDisplay, s), 10, 50, msg, strlen(msg));
//        }
...
// SBraich: Had problems linking <math.h> in JetBrains's CLION
// IDE, so we are adding sin and cosine here.
//
//double sin(double x)
//{
//    return x;
